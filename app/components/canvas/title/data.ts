...
export const RAW_TREE: Record<string, RawNodeData> = {
  ...
  'works-web': { id: 'works-web', color: '#E08E6D', img: '/images/node-image.jpg', icon: 'project', caption: 'Web Projects', children: ['web-1', 'web-2'], description: 'Next.js와 GSAP을 활용한 현대적인 웹 프로젝트 모음입니다.', tags: ['React', 'Next.js', 'CSS Modules'], linkUrl: '' },
  'works-game': { id: 'works-game', color: '#B5749E', img: '/images/node-image.jpg', icon: 'project', caption: 'Game Projects', children: ['game-1'], description: 'Unity와 Canvas API를 이용한 게임 개발 기록입니다.', tags: ['Unity', 'C#', 'Crayon Texture Engine'], linkUrl: '' },
  ...
  'web-1': { id: 'web-1', color: '#F2A68D', img: '/images/node-image.jpg', icon: 'project', caption: 'Portfolio Site', children: [], description: '현재 보고 계시는 인터랙티브 노드 맵 포트폴리오입니다. 아날로그 드로잉 필터와 무한 캔버스 내비게이션을 결합하여 감성적인 UX를 극대화했습니다.', tags: ['React', 'Next.js', 'React Konva', 'GSAP', 'Web Audio API'], linkUrl: '/works/web-1-portfolio' },
