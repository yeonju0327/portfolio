...
export const RAW_TREE: Record<string, RawNodeData> = {
  ...
  'web-1': { id: 'web-1', color: '#F2A68D', img: '/images/node-image5.jpg', icon: 'project', caption: 'Portfolio Site', children: [], description: '현재 보고 계시는 인터랙티브 노드 맵 포트폴리오입니다. 아날로그 드로잉 필터와 무한 캔버스 내비게이션을 결합하여 감성적인 UX를 극대화했습니다.', tags: ['React', 'Next.js', 'React Konva', 'GSAP', 'Web Audio API'], linkUrl: '/works/web-1-portfolio' },
