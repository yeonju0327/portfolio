...
export const RAW_TREE: Record<string, RawNodeData> = {
  ...
  'works-web': { id: 'works-web', color: '#E08E6D', img: '/images/node-image5.jpg', icon: 'project', caption: 'Web Projects', children: ['web-1', 'web-2'], description: 'Next.js와 GSAP을 활용한 현대적인 웹 프로젝트 모음입니다.', tags: ['React', 'Next.js', 'CSS Modules'], linkUrl: '' },
  'works-game': { id: 'works-game', color: '#B5749E', img: '/images/node-image2.jpg', icon: 'project', caption: 'Game Projects', children: ['game-1'], description: 'Unity와 Canvas API를 이용한 게임 개발 기록입니다.', tags: ['Unity', 'C#', 'Crayon Texture Engine'], linkUrl: '' },
  ...
  'works-design': { id: 'works-design', color: '#DDA05B', img: '/images/node-image3.jpg', icon: 'project', caption: 'Design', children: ['design-1', 'design-2'], description: '사용자 경험을 최우선으로 고려한 UI/UX 디자인 작업물입니다.', tags: ['Figma', 'UI/UX', 'Interaction Design'], linkUrl: '' },
  'web-1': { id: 'web-1', color: '#F2A68D', img: '/images/node-image5.jpg', icon: 'project', caption: 'Portfolio Site', children: [], description: '현재 보고 계시는 인터랙티브 노드 맵 포트폴리오입니다. 아날로그 드로잉 필터와 무한 캔버스 내비게이션을 결합하여 감성적인 UX를 극대화했습니다.', tags: ['React', 'Next.js', 'React Konva', 'GSAP', 'Web Audio API'], linkUrl: 'https://github.com/yeonju0327/portfolio' },
  'web-2': { id: 'web-2', color: '#F2A68D', img: '/images/node-image5.jpg', icon: 'project', caption: 'E-commerce', children: [], description: '반응형 디자인이 적용된 쇼핑몰 웹사이트입니다. 아날로그 룩앤필의 찢어진 종이 메타포 카드 결제 UI를 탑재했습니다.', tags: ['React', 'Redux Toolkit', 'TailwindCSS', 'Node.js'], linkUrl: 'https://github.com/yeonju0327/e-commerce' },
  'game-1': { id: 'game-1', color: '#C88AB2', img: '/images/node-image2.jpg', icon: 'project', caption: '2D Platformer', children: [], description: '부드러운 조작감을 자랑하는 2D 플랫포머 게임입니다. 손그림 스타일의 텍스처 맵과 잉크 번짐 파티클 효과를 자체 구현했습니다.', tags: ['Unity 2D', 'C#', 'Spine 2D Animation'], linkUrl: 'https://github.com/yeonju0327/crayon-platformer' },
  ...
  'design-1': { id: 'design-1', color: '#F0B675', img: '/images/node-image3.jpg', icon: 'project', caption: 'Brand Identity', children: [], description: '가상의 아날로그 카페 브랜드를 위한 로고, 컵 슬라이더 홀더, 비정형 포스트잇 패키지 및 브랜딩 가이드 디자인입니다.', tags: ['Adobe Illustrator', 'Branding', 'Package Design'], linkUrl: 'https://behance.net/yeonju-cafe' },
  'design-2': { id: 'design-2', color: '#F0B675', img: '/images/node-image3.jpg', icon: 'project', caption: 'UI/UX App', children: [], description: '사용자 친화적인 일정 관리 모바일 앱 디자인입니다. 다이어리 꾸미기 감성을 살린 손그림 아이콘 테마가 특징입니다.', tags: ['Figma', 'UI/UX Design', 'Prototype Interaction'], linkUrl: 'https://behance.net/yeonju-diary-app' },
};
